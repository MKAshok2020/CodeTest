...
namespace Plano.Models
{
    ...
    public class FakePlanoDbContext : IPlanoDbContext
    {
        ...
        public FakePlanoDbContext()
        {
            _database = new FakeDatabaseFacade(new PlanoDbContext());

            CurrencyProps = new FakeDbSet<CurrencyProp>("Cpid");
            ExchangeRates = new FakeDbSet<ExchangeRate>("Erid");
